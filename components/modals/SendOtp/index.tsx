...
import { setEmail, setPassword, setPhone, setOtp } from "@/store/authslice";
...
export const SendOtpDialog: React.FC<SendOtpDialogProps> = memo(
  ({ type, label, submitBtnLabel, handleSubmit, otp, setOtp = () => {} }) => {
    const dispatch = useDispatch();
    const { phone, email, password } = useSelector(
            ...
            <div className="relative flex items-center w-full">
              ...
              {type === "Phone" && (
                <Badge
                  ...
                  style={{
                    backgroundColor: otp?.length ? "#E7FFE5" : "#D0F500",
                    color: otp?.length ? "#35C329" : "#000000",
                  }}
                  onClick={() => (otp ? null : dispatch(setOtp("123467")))} // Mock OTP send
                >
