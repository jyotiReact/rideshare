  ...
  return (
    <div className="flex w-full items-start gap-2.5 ">
      ...
      <div className="flex items-center gap-2.5 relative flex-1">
        ...
        <div className="flex items-center gap-1 px-5 py-3 relative flex-1 rounded-[40px] border border-[#d9d9d9]">
          ...
          <label
            ...
            className="font-bold text-black text-sm [font-family:'Plus_Jakarta_Sans',Helvetica] tracking-[0] leading-[normal]"
          >
            From:
          </label>
          ...
          <input
            ...
            className="flex-1 border-none focus:outline-none bg-transparent font-medium text-[#515251] text-sm tracking-[0] leading-[normal] placeholder:text-[#b0b0b0]"
          />
        </div>
      ...
      <div className="inline-flex items-center gap-2.5">
        <Button
          variant="outline"
          className="flex gap-2 items-center  bg-transparent font-medium text-[#515251] text-sm tracking-[0] leading-[normal] rounded-full py-6 "
        >
        ...
        <Button
          variant="outline"
          className="flex gap-2 bg-transparent items-center font-medium text-[#515251] text-sm tracking-[0] leading-[normal] rounded-full py-6 "
        >
      ...
      >
        ...
        <span className="font-medium text-white text-sm tracking-[0] leading-[normal]">
          Search Rides
        </span>
      </Button>
    </div>
